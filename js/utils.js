...
function changeTheme() {
	...
	document.body.style.setProperty('--background', aqua ? "#001f3f" : "#f0f0f0")
	document.body.style.setProperty('--background_tooltip', aqua ? "rgba(0, 15, 31, 0.75)" : "rgba(240, 240, 240, 0.75)")
	document.body.style.setProperty('--color', aqua ? "#bfdfff" : "#fdfdfd")
	document.body.style.setProperty('--points', aqua ? "#dfefff" : "#000000")
	document.body.style.setProperty("--locked", aqua ? "#c4a7b3" : "#fb8f8f")
}
